		...
		***************/
		?><div id="content-body">
						...
						<tbody>
							...
							<tr>
								...
								<td class="quantity">
									...
									<input type="button" class="sml-button" alt="<?php echo $button_update; ?>" value="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
			...
			***************/
			?><?php if ($coupon_status || $voucher_status || $reward_status || $shipping_status) { ?>
				<div class="cart-module">
					...
					<div class="content">
						...
						<?php } ?>
						<div id="shipping" class="data" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
							<?php echo $text_shipping_detail; ?><br /><br />
							<table class="form">
								<tr>
			...
			<div class="buttons">
				<div class="right"><a href="<?php echo $checkout; ?>" class="button dark-bt"><?php echo $button_checkout; ?></a></div>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html += '<h2 class="header-4"><?php echo $text_shipping_method; ?></h2>';
