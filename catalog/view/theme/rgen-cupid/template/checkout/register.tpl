	...
	<div class="box-form left">
		...
		<table class="form">
			...
			<tr>
				...
				<td><input type="text" name="email" value="" class="large-field" /><br /></td>
			</tr>
			<tr>
				<td><span class="required">*</span> <?php echo $entry_telephone; ?></td>
				<td><input type="text" name="telephone" value="" class="large-field" /><br /></td>
			</tr>
			<tr>
				<td><?php echo $entry_fax; ?></td>
				<td><input type="text" name="fax" value="" class="large-field" /><br /></td>
			</tr>
		</table><br />
		...
		<table class="form">
			<tr>
				...
				<td><input type="password" name="password" value="" class="large-field" /><br /></td>
			</tr>
			<tr>
				<td><span class="required">*</span> <?php echo $entry_confirm; ?></td>
				<td><input type="password" name="confirm" value="" class="large-field" /><br /></td>
			</tr>
		</table>
	</div>
	<div class="box-form right">
		...
		<table class="form">
			<tr>
				...
				<td><input type="text" name="company" value="" class="large-field" /><br /></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="address_2" value="" class="large-field" /><br /></td>
			</tr>
			<tr>
