<?php if ($this->config->get('RGen_SlideShow_Latest') && $getRoute == 'common/home') { ?>
<div class="box latest-prd slidshow-prd" id="LatestOnSlideshow<?php echo $module; ?>">
<?php }else { ?>
<div class="box latest-prd" id="latest-prd<?php echo $module; ?>">
<?php } ?>

	<?php if ($this->config->get('RGen_SlideShow_Latest') && $getRoute == 'common/home') { ?>
	<div id="latestPrd" class="box-heading header-1"><?php echo $heading_title; ?></div>
	<?php }else { ?>
...
$(document).ready(function(){
	<?php if ($this->config->get('RGen_SlideShow_Latest') && $getRoute == 'common/home') { ?>
		...
		var obj = $('#LatestOnSlideshow<?php echo $module; ?>');
