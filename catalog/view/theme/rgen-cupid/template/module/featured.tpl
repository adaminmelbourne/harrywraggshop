<?php if ($this->config->get('RGen_SlideShow_Featured') && $getRoute == 'common/home') { ?>
<div class="box featured-prd slidshow-prd" id="FeaturedOnSlideshow<?php echo $module; ?>">
<?php }else { ?>
<div class="box featured-prd" id="featured-prd<?php echo $module; ?>">
<?php } ?>

	<?php if ($this->config->get('RGen_SlideShow_Featured') && $getRoute == 'common/home') { ?>
	<div id="featuredPrd" class="box-heading header-1"><?php echo $heading_title; ?></div>
	<?php }else { ?>
			...
			<?php foreach ($products as $product) { ?>
				...
				<?php } ?>
					...
					<div class="image">
						...
						<div class="info" onclick="location.href='<?php echo $product['href']; ?>'">
...
$(document).ready(function(){
	<?php if ($this->config->get('RGen_SlideShow_Featured') && $getRoute == 'common/home') { ?>
		...
		var obj = $('#FeaturedOnSlideshow<?php echo $module; ?>');
	...
	<?php }else { ?>
		...
		var obj = $('#featured-prd<?php echo $module; ?>');
		...
		if(obj.find('.prd-block').length >= 4 & posChk == false){
			...
			obj.find('.scrollPane').jScrollPane({ horizontalDragMinWidth: 40, horizontalDragMaxWidth: 40, hideFocus:true });
		}
