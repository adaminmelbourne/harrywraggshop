			...
			<table class="compare-info list">
				...
				<tbody>
					...
					<tr>
						...
						<?php foreach ($products as $product) { ?>
						<td>
							<b class="rating lrg-stars stars-<?php echo $products[$product['product_id']]['rating']; ?>" title="<?php echo $products[$product['product_id']]['reviews']; ?>"></b>
							<br />
				...
				<tr>
					<td></td>
					<?php foreach ($products as $product) { ?>
					<td><input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="dark-bt button" /></td>
					<?php } ?>
				</tr>
				<tr>
					<td></td>
