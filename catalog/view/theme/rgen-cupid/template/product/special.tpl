...
<div id="content">
	<div id="main" class="wrapper clearfix"><?php
		...
		***************/
		...
		/* PAGE CONTENT
		***************/
		?><div id="content-body" class="special">
...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<a onclick="display(\'list\');" class="icon-list" title="<?php echo $text_list; ?>"><?php echo $text_list; ?></a><span title="<?php echo $text_grid; ?>" class="icon-grid"><?php echo $text_grid; ?></span>');
